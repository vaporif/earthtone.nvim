return function(hi, c)
  ...
  hi('@lsp.type.class.typescript', { fg = c.teal })
  hi('@lsp.type.enum.typescript', { fg = c.teal })
  ...
  hi('@lsp.type.class.typescriptreact', { fg = c.teal })
  hi('@lsp.type.enum.typescriptreact', { fg = c.teal })
